...
type = c("provider", "provider", "ic", "ic", "oc", "oc")
...
ggplot(data = bene, aes(x=total_chronic, color=Gender)) + geom_histogram(binwidth=1, fill="white", position="identity", alpha=.5)
...
ggplot(data=days_admitted_age, aes(x=Age, y=Mean, fill=PotentialFraud)) + geom_bar(position = "dodge", stat="identity")
